 ...
 * @author ACER
 */
public class EditStudents_Year2 extends javax.swing.JFrame {
    Connection con = null;
    ...
    /**
     * Creates new form EditStudents_Year2
     */
    public EditStudents_Year2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 491));

        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 0, -1, 491));
        ...
        jPanel3.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, 650, 420));
        ...
        year2.setBackground(new java.awt.Color(153, 0, 153));
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        try {
            ...
            ps1 = con.prepareStatement("UPDATE studentsY2 SET year=?,semester=?,programme=?, grpno=?,grpid=?,subgno=?,subgid=?  WHERE stuid=? ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditStudents_Year2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditStudents_Year2().setVisible(true);
            }
        });
    }
