 ...
 * @author Oshani
 */
public class AddStudents_Year4 extends javax.swing.JFrame {
    Connection con = null;
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        ...
        try{
            ...
            AddStudents_Year4 ob4=new  AddStudents_Year4();
            ob4.setVisible(true);
            this.setVisible(false);

        }  catch (SQLException ex) {
            Logger.getLogger(AddStudents_Year4.class.getName()).log(Level.SEVERE, null, ex);
        }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddStudents_Year4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddStudents_Year4().setVisible(true);
            }
        });
    }
