...
public class ViewWorkingDays_new extends javax.swing.JFrame {
    ...
    private void Delete1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Delete1ActionPerformed
        ...
        System.out.println("deleteeeee"+id);
        delete1(y);
        }catch(Exception e){}
    ...
    private void TagActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TagActionPerformed
        ...
        try {
            con = dbdetail.getCon();
            ps26=con.prepareStatement("delete from Details where DId=?");
            ps26.setInt(1,id);
            ps26.execute();
    ...
    private void editDetails(int nodays, String Monday1,String Tuesday1, String Wednesday1, String Thursday1,String Friday1, String Saturday1,String Sunday1, String time , String timeSlot ){
         ...
         try {
                       ...
                       // ps3 = con.prepareStatement("insert into lec(name,emmid,faculty,department,center,building,level,rank123) values(?,?,?,?,?,?,?,?) where id=? ");
                        ps3 = con.prepareStatement("UPDATE Details SET nodays=?,monday=?,tuesday=?,wednesday=?,thursday=?,friday=?,saturday=?,sunday=?,time=?,timeslot=?  where DId=? ");
