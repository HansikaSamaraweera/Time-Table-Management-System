 ...
 * @author OSHANI
 */
public class addnotOverlapSession extends javax.swing.JFrame {
    ...
    /**
     * Creates new form addnotOverlapSession
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, 430, 580));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 90, 470, 580));

        jPanel3.setBackground(new java.awt.Color(255, 255, 255));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel3.setText("Not Overlap Sessions");
...
private int studentId(int id){
    ...
    private String[] checkValidSession(int id){
        ...
        try {
            ...
            ps5 = con.prepareStatement("select date,time from notOverlap where session1 =?");
            ps5.setInt(1, id);
            ResultSet rs2 = ps5.executeQuery();
    ...
    private void AddSessionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddSessionActionPerformed
        ...
        if(y==-67){
            JOptionPane.showMessageDialog(null, "Same location provided.Please select different location.");
        }
        else if(y==-29){
            JOptionPane.showMessageDialog(null, "A session is already schedule on this date and time");
        }
        else if(y==-89){
        ...
        addnotOverlapSession ob4=new addnotOverlapSession();
        ob4.setVisible(true);
    ...
    private void session_view_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_session_view_tableMouseClicked
        ...
        try{
            if(!arrLec[0].equalsIgnoreCase("Check")){
                JOptionPane.showMessageDialog(null,"This is not a valid session or already added.Please select valid sessions.");
            }
            else{
    ...
    private int calledByAddSessions(String[] arrSession){
       ...
       // System.out.println("spliit array"+jj);
        ...
        String[] check =checkValidSession(sessionID1);
        String[] check2=checkValidSession(sessionID2);
   ...
   try {
    ...
    private void UpdateSession(int sid){
         try {
           ...
           con = dbdetail.getCon();
            ps2 = con.prepareStatement("UPDATE sessions set status='Not_Overlap' where id=?");
             ps2.setInt(1, sid);
   ...
   private int findLectuersHasCreatedTheTable(int id){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addnotOverlapSession.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addnotOverlapSession().setVisible(true);
            }
        });
    }
