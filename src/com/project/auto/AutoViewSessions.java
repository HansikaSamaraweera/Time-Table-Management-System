 ...
 * @author vnaso
 */
public class AutoViewSessions extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("AUTO ADD SESSIONS TO THE TIME TABLES");
        ...
        jButton4.setText("AUTO GENARATE");
    ...
    private void autoSelect(){
        ...
        int itemRoom=0;
        int index=session_view_table.getRowCount();
        for(int k=0;k<index;k++){
            int sessionIteration=k;
            session_view_table.setRowSelectionInterval(k, k);
            int y=-90;
            int k_id=-45;
        //ADD LOC AND RAW ID
        ...
        //System.out.println("AutoSelect"+itemRoom);
         //ADD SESSIONS TO THE TABLE
        //Taking One Session At a time
        
        int[] count = getStudentrowcount_Index(k_id);
        System.out.println("pppp"+count[0]+"pppppppppppppppp"+count[1]);
        
        int starting=count[1]-count[0];
        System.out.println("couuuuuuunt"+starting);
        
        for(Object tt : arrayRooms){
             //System.out.println("for1"+tt);
        for(int gg=0;gg<7;gg++){
            System.out.println("for2"+gg);
            for(int yy=starting;yy<count[1];yy++){
            
                //location
                //row id
                //day
                
                int hhh = setValues(yy,tt,gg);
                 JOptionPane.showMessageDialog(null,"Adding this session to Time table is preceeding.Checking Whther this slot is available.");
               
                int sess=addAutoSessions();
                if(sess==-1000){
                ...
                if(sess==-66){
                JOptionPane.showMessageDialog(null, "Some tables has not created yet.So that you cannot Automatically add this.");
                     sessionIteration=-21;
                     break;
                }
               
            }
            if(sessionIteration==-21){
                break;
            }
        }
         if(sessionIteration==-21){
          ...
          Logger.getLogger(AutoViewSessions.class.getName()).log(Level.SEVERE, null, e);
        }
        }
    ...
    private int setValues(int yy,Object tt,int gg){
        System.out.println("se valuesssss");
                 R_ID.setValue(yy);
                loc_id.setSelectedItem(tt);
                C_ID.setSelectedIndex(gg);
        return 0;
    }
    ...
    ArrayList ar=new ArrayList();
        try {
            ...
            Logger.getLogger(AutoViewSessions.class.getName()).log(Level.SEVERE, null, ex);
        }
        return ar;
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        /*String sesId=SID.getText();
        int ss=Integer.parseInt(sesId);
        
        int[] arr=rowids(ss);*/
         autoSelect();
    }//GEN-LAST:event_jButton4ActionPerformed
    private int[] rowids(int sid){
    ...
    try{
      ...
      int locationID = -500;
     // int incase_l=Integer.parseInt(hh);
            try{
                locationID=(int) loc_id.getSelectedItem();
                 
            }catch(Exception e){
                System.out.println("lllllllllll"+locationID);
       ...
       // System.out.println("spliit array"+jj);
        ...
        System.out.println("llllllllll"+locationID);
    ...
    public int[] getStudentrowcount_Index(int id) {
        int[] arr=new int[2];
         try {
             ...
             ps5 = con.prepareStatement("select id from stu_timetable where stuid =?");
             ps5.setInt(1, id);
             ResultSet rs2 = ps5.executeQuery();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AutoViewSessions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AutoViewSessions().setVisible(true);
            }
        });
    }
...
private ArrayList getsessions(){
     ArrayList arr=new ArrayList();
        try {
            ...
            con = dbdetail.getCon();
            ps1 = con.prepareStatement("select id,lec,tag,s_grp,sub_grp,subject_c,no_students,duration,status from sessions where status='Normal'");
            ResultSet rs12 = ps1.executeQuery();
