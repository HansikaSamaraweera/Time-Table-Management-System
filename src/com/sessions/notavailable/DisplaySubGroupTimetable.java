 ...
 * @author OSHANI
 */
public class DisplaySubGroupTimetable extends javax.swing.JFrame {
    private static Connection con;
    private PreparedStatement ps1;
    /**
     * Creates new form DisplaySubGroupTimetable
     */
    public DisplaySubGroupTimetable() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Students Sub Group Time Table");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ArrayList<subgroupStructure> ar= getStudentStr(sid);

        for(Object x:ar){
            subgroupStructure object=new subgroupStructure();
            object = (subgroupStructure) x;
            row[0]=object.getId();
     ...
     private void getStudentName(int rid){
         try {
             con = dbdetail.getCon();
             ps1 = con.prepareStatement("select subgrp from subgrp where id=?");
             ps1.setInt(1,rid);
             ...
             Logger.getLogger(DisplaySubGroupTimetable.class.getName()).log(Level.SEVERE, null, ex);
         }
   }
     
     private ArrayList<subgroupStructure> getStudentStr(int rid){
         ArrayList arr=new ArrayList();
        try {
            con = dbdetail.getCon();
            ps1 = con.prepareStatement("select did,id,timeslot,mon,tue,wed,thur,fri,sat,sun from stu_sub_timetable where id=?");
            ps1.setInt(1,rid);
            ResultSet rs12 = ps1.executeQuery();
            
            while (rs12.next()) {
                //name+emmid+faculty+department+center+building+level+rank123
                subgroupStructure ar=new subgroupStructure();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisplaySubGroupTimetable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DisplaySubGroupTimetable().setVisible(true);
            }
        });
    }
