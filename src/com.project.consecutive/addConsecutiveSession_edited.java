...
import com.project.parallelSession.*;
 ...
 * @author ACER
 */
public class addConsecutiveSession_edited extends javax.swing.JFrame {
private static Connection con;
     ...
     */
    public addConsecutiveSession_edited() {
        initComponents();
        show_sessions();
    }
    ...
    private void AddSessionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddSessionActionPerformed
        ...
        addConsecutiveSession_edited ob4=new addConsecutiveSession_edited();
        ob4.setVisible(true);
   ...
   private int findLectuersHasCreatedTheTable(int id){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addConsecutiveSession_edited.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addConsecutiveSession_edited().setVisible(true);
            }
        });
    }
